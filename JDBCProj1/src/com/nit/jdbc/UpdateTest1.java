...
public class UpdateTest1 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Enter percentage for sal hike:");
			percentage = sc.nextFloat();
			System.out.println("Enter first sal range:");
			startSal = sc.nextFloat();
			System.out.println("Enter last sal range:");
			lastSal = sc.nextFloat();
			...
			String query="UPDATE EMP SET SAL = SAL + (SAL *"+percentage/100+") WHERE SAL>="+startSal+" AND SAL<="+lastSal;
